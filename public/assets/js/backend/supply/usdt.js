            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'act_usdt', title: "实际到账", operate:false},
                        {field: 'hash', title: "到账地址", operate: 'LIKE', table: table, class: 'autocontent', formatter: Table.api.formatter.content,with:340},
                        {field: 'type', title:"通道", operate: 'LIKE', table: table, class: 'autocontent', formatter: Table.api.formatter.content},
                        {field: 'pinzheng_images', title: "凭证", operate: false, events: Table.api.events.images, formatter: Table.api.formatter.images},
                        {field: 'address', title: "哈希值", operate: 'LIKE', table: table, class: 'autocontent', formatter: Table.api.formatter.content},
