            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'hash', title: "到账地址", operate: 'LIKE', table: table, class: 'autocontent', formatter: Table.api.formatter.content},
                        {field: 'type', title:"通道", operate: 'LIKE', table: table, class: 'autocontent', formatter: Table.api.formatter.content},
                        {field: 'pinzheng_images', title: "凭证", operate: false, events: Table.api.events.image, formatter: Table.api.formatter.image},
