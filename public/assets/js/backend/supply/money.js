define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'supply/money/index' + location.search,
                    add_url: 'supply/money/add',
                    edit_url: 'supply/money/edit',
                    del_url: 'supply/money/del',
                    multi_url: 'supply/money/multi',
                    import_url: 'supply/money/import',
                    table: 'supply_money_log',
                }
            });
