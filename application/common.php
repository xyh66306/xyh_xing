...
if (!function_exists('getOrderNo')) {
    ...
    {
        if ($type == 'order') {
            return 'O'.rand(10, 99).date('is') . rand(100, 999);
        } elseif ($type == 'withdraw') {
            //提现单号
            return 'T'.rand(10, 99).date('is') . rand(100, 999);
        } elseif ($type == 'recharge') {
            //充值单号
            return 'R'.rand(10, 99).date('is') . rand(100, 999);
        }elseif ($type == 'transfer') {
            //转账单号
            return 'T'.rand(10, 99).date('is') . rand(100, 999);
        }elseif ($type == 'uchongzhi') {
            //U充单号
            return 'fcz'.rand(10, 99).date('is') . rand(1, 9);
        } elseif ($type == 'uzhuanchu') {
            //U转单号
            return 'fzc'.rand(10, 99).date('is') . rand(1, 9);
        }elseif ($type == 'user') {
            //用户编号
            return 'fm'.rand(10, 99).date('is') . rand(10, 99);
        } elseif ($type == 'money') {
            //金额单号
            return 'qm'.rand(10, 99).date('is') . rand(10, 99);
        } elseif ($type == 'bank') {
            //银行卡编号
            return 'bk'.rand(10, 99).date('is') . rand(10, 99);
        }  elseif ($type == 'ewm') {
            //二维码编号
            return 'ewm'.rand(1, 9).date('is') . rand(10, 99);
        }   else {
            return 'f'.rand(10, 99).date('is') . rand(100, 999);
        }
