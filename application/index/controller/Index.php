...
class Index extends Frontend
{
    ...
    public function tongji(){
        ...
        $today_total2 = $rujinModel->where("pay_status",'>=',1)->whereTime('ctime', 'today')->count("id");
        ...
        $cj_supply_today_money2 = $chujinModel->whereTime('updatetime', 'today')->sum("withdrawAmount");
        ...
        $cj_today_total2 = $chujinModel->whereTime('updatetime', 'today')->count("id");
