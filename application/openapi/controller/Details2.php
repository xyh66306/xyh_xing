...
class Details extends Api
{
    ...
    */   
    public function payOrder(){ 
        ...
        $this->sendNotice($userInfo,$info['amount']);
    ...
    public function sendNotice($userInfo,$amount){
        ...
        $msg = "用户ID".$userInfo['id']."当前有一笔新的兑出订单，金额：".$amount."您可以登录抢单查看。<a href='https://bingocn.wobeis.com/otc/#/pages/buy/buy'>点击查看</a>";
